...
var colission = Matter.SAT.colides(playerArrows[i].body,player.body);
}

function handleComputerArrowCollision() {
  colission = Matter.SAT.colission(computerArrows[i].body,computerArcher.body);
}
